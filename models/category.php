...
class Category
{
  ...
  {
    $db = DB::getInstance();
    $query = $db->prepare("CALL sp_insert_category(:name,:parent_id)");
  ...
  {
    $db = DB::getInstance();
    $query = $db->prepare("CALL sp_update_category(:id, :name, :parent_id)");
  ...
  {
    $db = DB::getInstance();
    $query = $db->prepare("CALL sp_delete_category(:id)");
